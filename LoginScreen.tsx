  ...
  return (
    ...
    >
      ...
      <div className="p-8 sm:p-10 pt-14" id="login-card-body">
            ...
            >
              ...
              <form onSubmit={handleRecoverPasswordSubmit} className="space-y-5" id="recovery-form">
                <div id="rec-email-field-container">
                  <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-2" htmlFor="rec-email-input">
                    Seu E-mail Cadastrado
                  </label>
                  <div className="relative" id="rec-email-input-wrapper">
                    <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-zinc-600">
                      <Mail className="w-4 h-4" />
                    </div>
                    <input
                ...
                <button
                  ...
                  type="submit"
                  disabled={recoveryLoading}
                  className="w-full py-3.5 px-4 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-black rounded-2xl text-xs font-bold uppercase tracking-widest shadow-lg active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                >
                  {recoveryLoading ? (
                ...
                <button
                  ...
                  className="w-full py-2.5 text-[10px] text-zinc-500 hover:text-white transition-colors font-bold uppercase tracking-wider cursor-pointer"
                >
                  Voltar para o Login
                </button>
              </form>
        ...
        {/* Footer */}
        {!isRecovering && (
          <div className="mt-8 pt-6 border-t border-zinc-900/60 text-center" id="login-footer">
      ...
      <GoogleGuideModal isOpen={isGoogleGuideOpen} onClose={() => setIsGoogleGuideOpen(false)} />
    </motion.div>
  );
}
